...
|--------------------|-------------|------------------------------------------------|
| ⏳ Time Complexity  | O(E)        | Depends on number of edges and heuristic efficiency |
| 🧠 Space Complexity | O(V)        | Frontier and visited sets require storage       |
...
<p align="center">
  <img 
    src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Best-first-search-example.svg/1200px-Best-first-search-example.svg.png" 
