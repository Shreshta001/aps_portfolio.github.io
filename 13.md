...
Pascal’s Triangle is a triangular array where each entry is the **sum of the two directly above it**. It represents binomial coefficients:
...
|-----|---------------------|----------------------------------|
| 0   |            1        | \(\binom{0}{0}\)                 |
| 1   |         1   1        | \(\binom{1}{0}, \binom{1}{1}\)   |
| 2   |       1   2   1      | \(\binom{2}{0}...\binom{2}{2}\)  |
| 3   |     1   3   3   1    | \(\binom{3}{0}...\binom{3}{3}\)  |

Each entry \(\binom{n}{k}\) denotes the number of ways to choose `k` items from `n`.
...
<p align="center">
  <img 
    ...
    alt="Pascal's Triangle Animation" 
    width="65%" 
...
👉 [Pascal’s Triangle](https://github.com/Shreshta001/aps_portfolio.github.io/blob/main/codes/2.cpp)
